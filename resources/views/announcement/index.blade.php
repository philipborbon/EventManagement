        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="{{action('AnnouncementController@edit', $announcement['id'])}}" class="btn btn-warning">Edit</a></td>
              <td>
                <form action="{{action('AnnouncementController@destroy', $announcement['id'])}}" method="post">
                  {{csrf_field()}}
